...
MODEL_DIR="./results_ft/full/$SUBJECT_NAME/SD1_4" # the result folder of finetuned model; please adjust it if needed
IMG_DIR="./outputs_ft/full/$SUBJECT_NAME/SD1_4" # please adjust it if needed
...
# VAL_TEXT="a $IDENTIFIER_NAME $CLASS_NAME wearing sunglasses and smoking"
VAL_TEXT="a $IDENTIFIER_NAME $CLASS_NAME in front of the Eiffel Tower"


CUDA_VISIBLE_DEVICES=0 python src/generate_single_prompt.py \
    --use_dpm_solver \
    --model_id $MODEL_DIR \
    --save_dir $IMG_DIR \
    --num_images 4 \
