...
UNET_TYPE="CompVis/stable-diffusion-v1-4" # to load unet
...
OUTPUT_DIR="./results_ft/lora/$SUBJECT_NAME/SD1_4" # please adjust it if needed
...
# DATA_DIR="/home/mm080/SnST/dreambooth_dataset/$SUBJECT_NAME"
